...
public class RecommendationController {
    ...
    @HystrixCommand(fallbackMethod = "getDefaultStreamRecommendations", commandProperties = {
     ...
     */
    @PostMapping("/batch")
    @HystrixCommand(fallbackMethod = "getBatchDefaultRecommendations", commandProperties = {
            @HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds", value = "10000")
    })
    @Timed(value = "recommendation.batch", description = "Time taken to generate batch recommendations")
    public Flux<RecommendationResponse> generateBatchRecommendations(
